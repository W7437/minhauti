...
function setup(){
  ...
  form.addEventListener("change",()=>{updateNeuroVisibility(false);updatePhysicalExamSuggestion();});
...
function updateRenalPreview(){
  ...
  el.className="result "+((r.worse||r.ureaAboveRef||(r.urine&&r.urine.label!=="diurese preservada"))?"warn":"muted");
