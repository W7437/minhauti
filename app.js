...
function summarizeTemperature(data=getData()){
  if(data.temp_status==="afebrile")return {text:"sem distermias"};
...
function updateGlyTempSummary(){
  ...
  if(tempBox){
    ...
    tempBox.textContent=temp.text
      ? temp.text.charAt(0).toUpperCase()+temp.text.slice(1)+"."
      : "Nenhuma informação de temperatura.";
  }
